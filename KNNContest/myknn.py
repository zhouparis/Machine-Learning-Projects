...
def knn_predict(
    ...
    # argpartition yields k unordered nearest; then we can sort just those k if we care 
    ...
    zeros = k - ones
    # Predict 1 if more ones than zeros; tie is also 0
    y_pred = (ones > zeros).astype(int)
    return y_pred

# evaluate error% and +rate
